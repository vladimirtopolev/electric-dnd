...
export function rotateCartesianVector(cartesianVector: CartesianVector | Offset, rotate: number): CartesianVector {
    const polarVector = fromCartesianToPolarVector(cartesianVector);
    return fromPolarToCartesianVector({...polarVector, deg: polarVector.deg + rotate});
}
